...
import { getVisibleCanvasNonTiledResources, getCurrentCanvas, getCanvasLabel, getSequenceViewingDirection, getLayersForVisibleCanvases, getVisibleCanvases, getViewer, getConfig, getCompanionWindowsForContent, selectInfoResponses } from '../state/selectors';
/**
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  var canvasWorld = new CanvasWorld(getVisibleCanvases(state, {
    windowId: windowId
