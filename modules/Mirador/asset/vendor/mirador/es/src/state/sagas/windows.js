...
var _marked = /*#__PURE__*/_regeneratorRuntime.mark(fetchWindowManifest),
    _marked2 = /*#__PURE__*/_regeneratorRuntime.mark(setCollectionPath),
    ...
    _marked6 = /*#__PURE__*/_regeneratorRuntime.mark(setCurrentAnnotationsOnCurrentCanvas),
    _marked7 = /*#__PURE__*/_regeneratorRuntime.mark(panToFocusedWindow),
    _marked8 = /*#__PURE__*/_regeneratorRuntime.mark(updateVisibleCanvases),
    _marked9 = /*#__PURE__*/_regeneratorRuntime.mark(setCanvasOfFirstSearchResult),
    _marked10 = /*#__PURE__*/_regeneratorRuntime.mark(setCanvasforSelectedAnnotation),
    _marked11 = /*#__PURE__*/_regeneratorRuntime.mark(fetchInfoResponses),
    _marked12 = /*#__PURE__*/_regeneratorRuntime.mark(windowsSaga);
...
import { setContentSearchCurrentAnnotation, selectAnnotation, setWorkspaceViewportPosition, updateWindow, setCanvas, fetchSearch, receiveManifest, fetchInfoResponse } from '../actions';
...
export function setCollectionPath(_ref2) {
  ...
  return _regeneratorRuntime.wrap(function setCollectionPath$(_context2) {
    while (1) {
...
export function setWindowStartingCanvas(action) {
  ...
  return _regeneratorRuntime.wrap(function setWindowStartingCanvas$(_context4) {
    while (1) {
...
export function setWindowDefaultSearchQuery(action) {
  ...
  return _regeneratorRuntime.wrap(function setWindowDefaultSearchQuery$(_context5) {
    while (1) {
...
export function setCurrentAnnotationsOnCurrentCanvas(_ref5) {
  ...
  return _regeneratorRuntime.wrap(function setCurrentAnnotationsOnCurrentCanvas$(_context6) {
    while (1) {
...
export function panToFocusedWindow(_ref6) {
  ...
  return _regeneratorRuntime.wrap(function panToFocusedWindow$(_context7) {
    while (1) {
...
export function updateVisibleCanvases(_ref8) {
  ...
  return _regeneratorRuntime.wrap(function updateVisibleCanvases$(_context8) {
    while (1) {
...
export function setCanvasOfFirstSearchResult(_ref9) {
  ...
  return _regeneratorRuntime.wrap(function setCanvasOfFirstSearchResult$(_context9) {
    while (1) {
...
export function setCanvasforSelectedAnnotation(_ref10) {
  ...
  return _regeneratorRuntime.wrap(function setCanvasforSelectedAnnotation$(_context10) {
    while (1) {
...
export function fetchInfoResponses(_ref11) {
  ...
  return _regeneratorRuntime.wrap(function fetchInfoResponses$(_context11) {
    while (1) {
...
export default function windowsSaga() {
  return _regeneratorRuntime.wrap(function windowsSaga$(_context12) {
    while (1) {
