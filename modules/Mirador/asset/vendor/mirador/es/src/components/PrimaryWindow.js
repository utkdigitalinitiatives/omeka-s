...
export var PrimaryWindow = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PrimaryWindow, [{
    ...
    value: function renderViewer() {
      ...
      if (isCollection) {
        return /*#__PURE__*/React.createElement(React.Fragment, null, isCollectionDialogVisible && /*#__PURE__*/React.createElement(CollectionDialog, {
          windowId: windowId
        }), /*#__PURE__*/React.createElement(SelectCollection, {
          windowId: windowId
        }));
      }
