...
import { getCompanionWindow, getWindow, getNextCanvasGrouping, getPreviousCanvasGrouping, getCanvases, getCanvasIndex, getWindowViewType, getSequenceViewingDirection, getConfig } from '../state/selectors';
/**
...
var mapStateToProps = function mapStateToProps(state, _ref) {
  ...
  var viewType = getWindowViewType(state, {
    windowId: windowId
  });
  return {
    canvasGroupings: new CanvasGroupings(getCanvases(state, {
      windowId: windowId
    }), viewType),
