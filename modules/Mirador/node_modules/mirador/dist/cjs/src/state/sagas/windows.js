...
var _marked = /*#__PURE__*/_regenerator["default"].mark(fetchWindowManifest),
    ...
    _marked12 = /*#__PURE__*/_regenerator["default"].mark(windowsSaga);
...
function fetchWindowManifest(action) {
  var _ref, collectionPath, manifestId;

  return _regenerator["default"].wrap(function fetchWindowManifest$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _ref = action.payload || action.window, collectionPath = _ref.collectionPath, manifestId = _ref.manifestId;
...
function windowsSaga() {
  return _regenerator["default"].wrap(function windowsSaga$(_context12) {
    while (1) {
