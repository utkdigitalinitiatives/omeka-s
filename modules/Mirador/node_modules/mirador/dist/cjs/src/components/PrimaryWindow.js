...
var PrimaryWindow = /*#__PURE__*/function (_Component) {
  ...
  _createClass(PrimaryWindow, [{
    ...
    value: function renderViewer() {
      ...
      if (isCollection) {
        return /*#__PURE__*/_react["default"].createElement(_react["default"].Fragment, null, isCollectionDialogVisible && /*#__PURE__*/_react["default"].createElement(_CollectionDialog["default"], {
          windowId: windowId
        }), /*#__PURE__*/_react["default"].createElement(SelectCollection, {
          windowId: windowId
        }));
      }
